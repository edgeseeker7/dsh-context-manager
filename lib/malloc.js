    ...
    try {
      ...
      if (step === 1) {
        ...
        if (jevApiKey !== undefined) {
          const verdicts = await jevRerank({ apiKey: jevApiKey, request: userText, candidates: pool });
          if (verdicts !== null) {
        ...
        if (jevApiKey !== undefined) {
          ...
          const verdicts = await jevSelectPages({ apiKey: jevApiKey, request: userText, pages });
          if (verdicts !== null) {
