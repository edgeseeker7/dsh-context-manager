...
function pinCleanupText(outcome) {
  ...
  if (outcome.quarantined !== undefined) {
    return ` The task pin file was corrupt and has been quarantined (${outcome.quarantined}); nothing to free — recover by hand if needed.`;
  }
